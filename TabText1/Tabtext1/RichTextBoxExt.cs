...
namespace MicrosoftMSDN
{
    ...
    public class RichTextBoxExt : RicherTextBox2
    {
        ...
        public Int32 HundredthInchToTwips(int n)
        {
            return (Int32)(n * 14.4);
        }
        /// <summary>
        ...
        /// <summary>
        /// Sets the strike style only for the selected part of the rich text box
        /// without modifying the other properties like font or size
        /// </summary>
        /// <param name="strike">make selection strike (true) or regular (false)</param>
        /// <returns>true on success, false on failure</returns>
        public bool SetSelectionStrike(bool strike)
        {
            return SetSelectionStyle(CFM_STRIKEOUT, strike ? CFE_STRIKEOUT : 0);
        }
