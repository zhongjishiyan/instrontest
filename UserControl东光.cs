...
namespace TabHeaderDemo
{
    public partial class UserControl东光 : UserControl
    {
        ...
        {
            GlobeVal.myarm.fatigtest(cbowave.SelectedIndex,Convert.ToSingle( numfreq.Value),Convert.ToSingle(numave.Value), Convert.ToSingle( numrange.Value), numcount.Value);
        }
